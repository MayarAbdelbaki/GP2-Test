...
Your PC's IP address: **192.168.56.1**

### Option 1: Using Environment Variable (Recommended)

On the autocar, run:
```bash
export WEBHOOK_URL=http://192.168.56.1:5000/webhook
...
```bash
echo 'export WEBHOOK_URL=http://192.168.56.1:5000/webhook' >> ~/.bashrc
source ~/.bashrc
```
...
- Send images to your PC at 192.168.56.1:5000/webhook
